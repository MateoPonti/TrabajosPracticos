...
public class Ejercicio12 {
    ...
    public  Ejercicio12(){
        ...
        lista.crearTarea("Ir al supermercado mañana", Estado.INCOMPLETA, Prioridad.BAJA,LocalDate.of(2025,2,7),LocalDate.of(2024,11,3));
        lista.crearTarea("Consultar repuesto del auto", Estado.COMPLETA, Prioridad.BAJA,LocalDate.of(2028,3,30),(LocalDate.now().minusDays(1)));
        lista.crearTarea("Ir al supermercado mañana", Estado.INCOMPLETA, Prioridad.MEDIA,LocalDate.of(2027,1,6),LocalDate.of(2027,1,4));
        lista.crearTarea("Comprar pan", Estado.INCOMPLETA, Prioridad.MEDIA,LocalDate.of(2026,5,5),LocalDate.of(24,10,7));
        lista.crearTarea("Ir a clases", Estado.INCOMPLETA, Prioridad.ALTA,LocalDate.of(2022,12,8),LocalDate.of(2022,11,7));
